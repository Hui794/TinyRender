...
#define test005filename ".\\obj\\Squirtle.obj"
...
int main(int argc, char** argv) {
	if (2 == argc) {
		...
		model = new Model(test005filename);
	}
	...
	//image.write_tga_file("outputSquirtle005.tga");
	image.write_tga_file("deoutputSquirtle005.tga");
	return 0;
}