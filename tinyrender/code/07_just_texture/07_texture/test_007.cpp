...
#define test007filename ".\\obj\\african_head.obj"

Model* model = NULL;
const int width = 1000;
const int height = 1000;
const float zoom = 2;	//2  5
const int xoffset = 0;	//0  300
const int yoffset = 0;	//0  -120
...
int main(int argc, char** argv) {
	if (2 == argc) {
		...
		model = new Model(test007filename);
	}
	...
	image.write_tga_file("output007.tga");
	return 0;
}